...
# -----------------------make two list of postback macro-----------------------------
        ...
        if self.radioButton1.isChecked():
            ...
            while i < len(split_query_strings):
                ...
                if value in attribution_macro_list:
                    ...
                    self.detailTextEdit.append(split_query_strings[i] + "-----valid macro")
                else:
                    self.detailTextEdit.append(split_query_strings[i] + "-----invalid macro")
                i = i + 1
                print(i)
        else:
            # compare attribution macro list with query strings
